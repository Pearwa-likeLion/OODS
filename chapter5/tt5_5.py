...
# def radix_sort(nums):
#     print('------------------------------------------------------------')
#     sort_num = sorted(nums)  # Sort the input list in ascending order
...
#             pos_digits[num_digit].append(cur_num)
#         for i in range(10):
#             print(f'{i} : {pos_digits[i].to_str()}')
...
def radix_sort(nums):
    ...
    print(f'{max_digit} Time(s)')
    print(f'Before Radix Sort : {before_linked_list}')
    print(f'After  Radix Sort : {linked_list.__str__()}')
